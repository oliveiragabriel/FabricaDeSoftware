$(function(){	
	...
	var Cpf= $(".main-form-input main-form-inputCPF").val();
	function EntradaNumerico(Cpf) {
	
	    var key_code = Cpf.keyCode  ? Cpf.keyCode  :
	                   Cpf.charCode ? Cpf.charCode :
	                   Cpf.which    ? Cpf.which    : void 0;
