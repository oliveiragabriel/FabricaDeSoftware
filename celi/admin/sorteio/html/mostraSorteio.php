				...
				<div class="main-content">
					...
					<table class="main-form">
						<tr>
							...
							<td class="main-table-title" >ID</td>
							<td class="main-table-title" >Nome</td>
							<td class="main-table-title" >RG</td>
							<td class="main-table-title" >CPF</td>
							<td class="main-table-title" >Data de nascimento </td>
							<td class="main-table-title" >Email</td>
							<td class="main-table-title" >Telefone1</td>
							<td class="main-table-title" >Telefone2 </td>
							<td class="main-table-title" >Situação</td>
							
						</tr>
					<!-- chamr as informaçoes do banco de dados de acordo com o id sorteados --> 
					
				
				<?php 
				$conexao = conexaobd();
				$result = mysqli_query($conexao, 'SELECT idcandidato, nome, rg, cpf, nascimento, email, telefone1, telefone2, situacao from candidato' ) or die(mysqli_error($conexao));
				while ($id = mysqli_fetch_array($result)) { 
				
				    ?>
				<tr>
					<td class="main-table-td"><?php echo $id['idcandidato']; ?></td>
					<td class="main-table-td"><?php echo $id['nome']; ?></td>
					<td class="main-table-td"><?php echo $id['rg']; ?></td>
					<td class="main-table-td"><?php echo $id['cpf']; ?></td>
					<td class="main-table-td"><?php echo $id['nascimento']; ?></td>
					<td class="main-table-td"><?php echo $id['email']; ?></td>
					<td class="main-table-td"><?php echo $id['telefone1']; ?></td>
					<td class="main-table-td"><?php echo $id['telefone2']; ?></td>
					<td class="main-table-td"><?php echo $id['situacao']; ?></td>
