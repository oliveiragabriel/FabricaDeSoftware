			...
			<div id="main">
				<div class="main-content">
					<h1 class="main-title">Excluir curso</h1>
						<p class="main-content-form-content-label"> Tem certeza que você deseja excluir definitivamente o curso de <?php echo $nome['nome']; ?></p>
						<form method="post" action="">
							<input type="hidden" name="excluirCurso" value="<?php echo $curso; ?>">
							<input class="main-content-form-content-send" type="submit" value="excluir">
						</form>
