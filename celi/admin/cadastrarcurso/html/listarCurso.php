...
<html lang="pt">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="./css/listaCurso.css">
	</head>
	<body>
				...
				<div class="main-content">
					...
					<table class="main-form-content-curso">
							<tr class="main-form-cursoTitle">
								...
								<td class="main-form-vagasLabel" colspan="2">
									<p class="main-form-vagasLabel-ctt">Ações</p>
								</td>
							</tr>
							<?php
							...
							<tr class="main-form-cursoLine">
								...
								<td class="main-form-cursoLine-nome"><?php echo $curso['nome']; ?></td>
								<td><button><a href="./excluir.php?curso=<?php echo $curso['idcurso']; ?>">Excluir</a></button></td>
								<td><button><a href="./editar.php?curso=<?php echo $curso['idcurso']; ?>">Editar</a></button></td>
							</tr>
					...
					<p> Total de cursos cadastrados: <?php echo $conta->num_rows; ?></p>
				</div>
			</main>
			<!-- FOOTER -->
			<footer id="footer">
